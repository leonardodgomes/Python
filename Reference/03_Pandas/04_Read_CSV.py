...
import pandas as pd
df = pd.read_xml('\\fileshare.ageas.pt\\Plataforma Vida\\P&BA\\Data Science\\questionarios\\env\\SOURCE\\PRTVIDA_QUESTS_0.csv')
print(df) 
...
df = pd.read_csv('C:\\Users\\a070127\\Documents\\Leonardo\\Work\\Python\\03_Pandas\\00_Files\\data.csv')
print(df) 
