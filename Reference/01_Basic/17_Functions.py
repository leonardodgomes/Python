...
#    No matter which way of running your code you’re using, Python defines a special variable called __name__ that contains
#    a string whose value depends on how the code is being used.
